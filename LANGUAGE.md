...
- [Control Flow -- IF / ELSE / WHILE](#control-flow-if--else--while)
- [Functions and Import](#functions-and-import)
- [Mouse Control and Jiggler](#mouse-control-and-jiggler)
- [HOLD / RELEASE](#hold--release)
- [ATTACKMODE -- USB Personality Switch](#attackmode--usb-personality-switch)
...
- [Full Demonstration Payload](#full-demonstration-payload)
- [Adding New Keyboard Layouts](#adding-new-keyboard-layouts)
